...
import (
	...
	gw "github.com/stabilaprotocol/grpc-gateway/api"

	"fmt"
)

var (
	port = flag.Int("port",50051, "port of your stabila grpc service" )
	host = flag.String("host", "localhost", "host of your stabila grpc service")
