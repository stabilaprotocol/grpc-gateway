...
func (AccountType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{0}
}
...
func (ReasonCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{1}
}
...
const (
	...
	Transaction_Contract_VoteexecutiveContract           Transaction_Contract_ContractType = 4
	Transaction_Contract_executiveCreateContract         Transaction_Contract_ContractType = 5
	...
	Transaction_Contract_executiveUpdateContract         Transaction_Contract_ContractType = 8
	...
	Transaction_Contract_CdBalanceContract         Transaction_Contract_ContractType = 11
	Transaction_Contract_UncdBalanceContract       Transaction_Contract_ContractType = 12
	Transaction_Contract_WithdrawBalanceContract       Transaction_Contract_ContractType = 13
	Transaction_Contract_UncdAssetContract         Transaction_Contract_ContractType = 14
...
var Transaction_Contract_ContractType_name = map[int32]string{
	...
	3:  "VoteAssetContract",
	4:  "VoteexecutiveContract",
	5:  "executiveCreateContract",
	6:  "AssetIssueContract",
	7:  "DeployContract",
	8:  "executiveUpdateContract",
	9:  "ParticipateAssetIssueContract",
	10: "AccountUpdateContract",
	11: "CdBalanceContract",
	12: "UncdBalanceContract",
	13: "WithdrawBalanceContract",
	14: "UncdAssetContract",
...
func (Transaction_Contract_ContractType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{10, 0, 0}
}
...
func (Transaction_ResultCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{10, 1, 0}
}
...
func (BlockInventory_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{17, 0}
}

type Inventory_InventoryType int32

const (
	Inventory_STB   Inventory_InventoryType = 0
...
func (Inventory_InventoryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{18, 0}
}
...
func (Items_ItemType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{19, 0}
}
...
type Account struct {
	...
	// the cded balance
	Cded []*Account_Cded `protobuf:"bytes,7,rep,name=cded,proto3" json:"cded,omitempty"`
	// bandwidth, get from cded
	...
	// executive block producing allowance
	...
	Isexecutive   bool   `protobuf:"varint,14,opt,name=is_executive,json=isexecutive,proto3" json:"is_executive,omitempty"`
	IsCommittee bool   `protobuf:"varint,15,opt,name=is_committee,json=isCommittee,proto3" json:"is_committee,omitempty"`
	// cded asset(for asset issuer)
	CdedSupply []*Account_Cded `protobuf:"bytes,16,rep,name=cded_supply,json=cdedSupply,proto3" json:"cded_supply,omitempty"`
	// asset_issued_name
...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{2}
}
...
func (m *Account) GetCded() []*Account_Cded {
	if m != nil {
		return m.Cded
	}
	return nil
...
func (m *Account) GetIsexecutive() bool {
	if m != nil {
		return m.Isexecutive
	}
	return false
}
...
func (m *Account) GetCdedSupply() []*Account_Cded {
	if m != nil {
		return m.CdedSupply
	}
	return nil
...
// cded balance
type Account_Cded struct {
	// the cded stb balance
	CdedBalance int64 `protobuf:"varint,1,opt,name=cded_balance,json=cdedBalance,proto3" json:"cded_balance,omitempty"`
	// the expire time
...
func (m *Account_Cded) Reset()         { *m = Account_Cded{} }
func (m *Account_Cded) String() string { return proto.CompactTextString(m) }
func (*Account_Cded) ProtoMessage()    {}
func (*Account_Cded) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{2, 0}
}
func (m *Account_Cded) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Account_Cded.Unmarshal(m, b)
}
func (m *Account_Cded) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Account_Cded.Marshal(b, m, deterministic)
}
func (dst *Account_Cded) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Account_Cded.Merge(dst, src)
}
func (m *Account_Cded) XXX_Size() int {
	return xxx_messageInfo_Account_Cded.Size(m)
}
func (m *Account_Cded) XXX_DiscardUnknown() {
	xxx_messageInfo_Account_Cded.DiscardUnknown(m)
}

var xxx_messageInfo_Account_Cded proto.InternalMessageInfo

func (m *Account_Cded) GetCdedBalance() int64 {
	if m != nil {
...
func (m *Account_Cded) GetExpireTime() int64 {
	if m != nil {
		return m.ExpireTime
	}
	return 0
...
func (*Acuthrity) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{3}
}
...
func (*Permision) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{4}
}
...
func (m *executive) Reset()         { *m = executive{} }
func (m *executive) String() string { return proto.CompactTextString(m) }
func (*executive) ProtoMessage()    {}
func (*executive) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{5}
}
func (m *executive) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_executive.Unmarshal(m, b)
}
func (m *executive) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_executive.Marshal(b, m, deterministic)
}
func (dst *executive) XXX_Merge(src proto.Message) {
	xxx_messageInfo_executive.Merge(dst, src)
}
func (m *executive) XXX_Size() int {
	return xxx_messageInfo_executive.Size(m)
}
func (m *executive) XXX_DiscardUnknown() {
	xxx_messageInfo_executive.DiscardUnknown(m)
}

var xxx_messageInfo_executive proto.InternalMessageInfo

func (m *executive) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *executive) GetVoteCount() int64 {
	if m != nil {
		return m.VoteCount
	}
	return 0
...
func (m *executive) GetPubKey() []byte {
	if m != nil {
		return m.PubKey
	}
	return nil
...
func (m *executive) GetUrl() string {
	if m != nil {
		return m.Url
	}
	return ""
...
func (m *executive) GetTotalProduced() int64 {
	if m != nil {
...
func (m *executive) GetTotalMissed() int64 {
	if m != nil {
...
func (m *executive) GetLatestBlockNum() int64 {
	if m != nil {
...
func (m *executive) GetLatestSlotNum() int64 {
	if m != nil {
...
func (m *executive) GetIsJobs() bool {
	if m != nil {
		return m.IsJobs
	}
	return false
...
func (*Votes) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{6}
}
...
func (*TXOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{7}
}
...
func (*TXInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{8}
}
...
func (*TXInputRaw) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{8, 0}
}
...
func (*TXOutputs) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{9}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{10}
}
...
func (*Transaction_Contract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{10, 0}
}
...
func (*Transaction_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{10, 1}
}
...
func (*TransactionRaw) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{10, 2}
}
...
func (*TransactionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{11}
}
...
func (*Transactions) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{12}
}
...
func (*TransactionSign) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{13}
}
...
type BlockHeader struct {
	...
	executiveSignature     []byte          `protobuf:"bytes,2,opt,name=executive_signature,json=executiveSignature,proto3" json:"executive_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{14}
}
...
func (m *BlockHeader) GetexecutiveSignature() []byte {
	if m != nil {
		return m.executiveSignature
	}
	return nil
}
...
type BlockHeaderRaw struct {
	...
	executiveId            int64    `protobuf:"varint,8,opt,name=executive_id,json=executiveId,proto3" json:"executive_id,omitempty"`
	executiveAddress       []byte   `protobuf:"bytes,9,opt,name=executive_address,json=executiveAddress,proto3" json:"executive_address,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*BlockHeaderRaw) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{14, 0}
}
...
func (m *BlockHeaderRaw) GetexecutiveId() int64 {
	if m != nil {
		return m.executiveId
	}
	return 0
}

func (m *BlockHeaderRaw) GetexecutiveAddress() []byte {
	if m != nil {
		return m.executiveAddress
	}
	return nil
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{15}
}
...
func (*ChainInventory) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{16}
}
...
func (*ChainInventory_BlockId) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{16, 0}
}
...
func (*BlockInventory) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{17}
}
...
func (*Inventory) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{18}
}
...
func (*Items) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{19}
}
...
func (*DynamicProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{20}
}
...
func (*DisconnectMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{21}
}
...
func (*HelloMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{22}
}
...
func (*HelloMessage_BlockId) Descriptor() ([]byte, []int) {
	return fileDescriptor_Stabila_ad771d49482484f1, []int{22, 0}
}
...
func init() {
	...
	proto.RegisterType((*Account_Cded)(nil), "protocol.Account.Cded")
	proto.RegisterType((*Acuthrity)(nil), "protocol.acuthrity")
	proto.RegisterType((*Permision)(nil), "protocol.permision")
	proto.RegisterType((*executive)(nil), "protocol.executive")
...
func init() { proto.RegisterFile("core/Stabila.proto", fileDescriptor_Stabila_ad771d49482484f1) }

var fileDescriptor_Stabila_ad771d49482484f1 = []byte{
