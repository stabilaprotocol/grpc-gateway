...
type VoteexecutiveContract struct {
	OwnerAddress         []byte                      `protobuf:"bytes,1,opt,name=owner_address,json=ownerAddress,proto3" json:"owner_address,omitempty"`
	Votes                []*VoteexecutiveContract_Vote `protobuf:"bytes,2,rep,name=votes,proto3" json:"votes,omitempty"`
	Support              bool                        `protobuf:"varint,3,opt,name=support,proto3" json:"support,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
...
func (m *VoteexecutiveContract) Reset()         { *m = VoteexecutiveContract{} }
func (m *VoteexecutiveContract) String() string { return proto.CompactTextString(m) }
func (*VoteexecutiveContract) ProtoMessage()    {}
func (*VoteexecutiveContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{5}
}
func (m *VoteexecutiveContract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VoteexecutiveContract.Unmarshal(m, b)
}
func (m *VoteexecutiveContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VoteexecutiveContract.Marshal(b, m, deterministic)
}
func (dst *VoteexecutiveContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoteexecutiveContract.Merge(dst, src)
}
func (m *VoteexecutiveContract) XXX_Size() int {
	return xxx_messageInfo_VoteexecutiveContract.Size(m)
}
func (m *VoteexecutiveContract) XXX_DiscardUnknown() {
	xxx_messageInfo_VoteexecutiveContract.DiscardUnknown(m)
}

var xxx_messageInfo_VoteexecutiveContract proto.InternalMessageInfo

func (m *VoteexecutiveContract) GetOwnerAddress() []byte {
	if m != nil {
		return m.OwnerAddress
	}
	return nil
...
func (m *VoteexecutiveContract) GetVotes() []*VoteexecutiveContract_Vote {
	if m != nil {
		return m.Votes
	}
	return nil
...
func (m *VoteexecutiveContract) GetSupport() bool {
	if m != nil {
		return m.Support
	}
	return false
...
type VoteexecutiveContract_Vote struct {
...
func (m *VoteexecutiveContract_Vote) Reset()         { *m = VoteexecutiveContract_Vote{} }
func (m *VoteexecutiveContract_Vote) String() string { return proto.CompactTextString(m) }
func (*VoteexecutiveContract_Vote) ProtoMessage()    {}
func (*VoteexecutiveContract_Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{5, 0}
}
func (m *VoteexecutiveContract_Vote) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VoteexecutiveContract_Vote.Unmarshal(m, b)
}
func (m *VoteexecutiveContract_Vote) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VoteexecutiveContract_Vote.Marshal(b, m, deterministic)
}
func (dst *VoteexecutiveContract_Vote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoteexecutiveContract_Vote.Merge(dst, src)
}
func (m *VoteexecutiveContract_Vote) XXX_Size() int {
	return xxx_messageInfo_VoteexecutiveContract_Vote.Size(m)
}
func (m *VoteexecutiveContract_Vote) XXX_DiscardUnknown() {
	xxx_messageInfo_VoteexecutiveContract_Vote.DiscardUnknown(m)
}

var xxx_messageInfo_VoteexecutiveContract_Vote proto.InternalMessageInfo

func (m *VoteexecutiveContract_Vote) GetVoteAddress() []byte {
	if m != nil {
		return m.VoteAddress
	}
	return nil
...
func (m *VoteexecutiveContract_Vote) GetVoteCount() int64 {
	if m != nil {
		return m.VoteCount
	}
	return 0
...
type executiveCreateContract struct {
	OwnerAddress         []byte   `protobuf:"bytes,1,opt,name=owner_address,json=ownerAddress,proto3" json:"owner_address,omitempty"`
...
func (m *executiveCreateContract) Reset()         { *m = executiveCreateContract{} }
func (m *executiveCreateContract) String() string { return proto.CompactTextString(m) }
func (*executiveCreateContract) ProtoMessage()    {}
func (*executiveCreateContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{6}
}
func (m *executiveCreateContract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_executiveCreateContract.Unmarshal(m, b)
}
func (m *executiveCreateContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_executiveCreateContract.Marshal(b, m, deterministic)
}
func (dst *executiveCreateContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_executiveCreateContract.Merge(dst, src)
}
func (m *executiveCreateContract) XXX_Size() int {
	return xxx_messageInfo_executiveCreateContract.Size(m)
}
func (m *executiveCreateContract) XXX_DiscardUnknown() {
	xxx_messageInfo_executiveCreateContract.DiscardUnknown(m)
}

var xxx_messageInfo_executiveCreateContract proto.InternalMessageInfo

func (m *executiveCreateContract) GetOwnerAddress() []byte {
	if m != nil {
		return m.OwnerAddress
	}
	return nil
...
func (m *executiveCreateContract) GetUrl() []byte {
	if m != nil {
		return m.Url
	}
	return nil
...
type executiveUpdateContract struct {
	OwnerAddress         []byte   `protobuf:"bytes,1,opt,name=owner_address,json=ownerAddress,proto3" json:"owner_address,omitempty"`
...
func (m *executiveUpdateContract) Reset()         { *m = executiveUpdateContract{} }
func (m *executiveUpdateContract) String() string { return proto.CompactTextString(m) }
func (*executiveUpdateContract) ProtoMessage()    {}
func (*executiveUpdateContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{7}
}
func (m *executiveUpdateContract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_executiveUpdateContract.Unmarshal(m, b)
}
func (m *executiveUpdateContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_executiveUpdateContract.Marshal(b, m, deterministic)
}
func (dst *executiveUpdateContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_executiveUpdateContract.Merge(dst, src)
}
func (m *executiveUpdateContract) XXX_Size() int {
	return xxx_messageInfo_executiveUpdateContract.Size(m)
}
func (m *executiveUpdateContract) XXX_DiscardUnknown() {
	xxx_messageInfo_executiveUpdateContract.DiscardUnknown(m)
}

var xxx_messageInfo_executiveUpdateContract proto.InternalMessageInfo

func (m *executiveUpdateContract) GetOwnerAddress() []byte {
	if m != nil {
		return m.OwnerAddress
	}
	return nil
...
func (m *executiveUpdateContract) GetUpdateUrl() []byte {
	if m != nil {
		return m.UpdateUrl
	}
	return nil
...
type AssetIssueContract struct {
	...
	CdedSupply            []*AssetIssueContract_CdedSupply `protobuf:"bytes,5,rep,name=cded_supply,json=cdedSupply,proto3" json:"cded_supply,omitempty"`
	StbNum                  int32                              `protobuf:"varint,6,opt,name=stb_num,json=stbNum,proto3" json:"stb_num,omitempty"`
...
func (m *AssetIssueContract) GetCdedSupply() []*AssetIssueContract_CdedSupply {
	if m != nil {
		return m.CdedSupply
	}
	return nil
...
func (m *AssetIssueContract) GetStbNum() int32 {
	if m != nil {
		return m.StbNum
	}
	return 0
...
type AssetIssueContract_CdedSupply struct {
	CdedAmount         int64    `protobuf:"varint,1,opt,name=cded_amount,json=cdedAmount,proto3" json:"cded_amount,omitempty"`
	CdedDays           int64    `protobuf:"varint,2,opt,name=cded_days,json=cdedDays,proto3" json:"cded_days,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AssetIssueContract_CdedSupply) Reset()         { *m = AssetIssueContract_CdedSupply{} }
func (m *AssetIssueContract_CdedSupply) String() string { return proto.CompactTextString(m) }
func (*AssetIssueContract_CdedSupply) ProtoMessage()    {}
func (*AssetIssueContract_CdedSupply) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{8, 0}
}
func (m *AssetIssueContract_CdedSupply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AssetIssueContract_CdedSupply.Unmarshal(m, b)
}
func (m *AssetIssueContract_CdedSupply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AssetIssueContract_CdedSupply.Marshal(b, m, deterministic)
}
func (dst *AssetIssueContract_CdedSupply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetIssueContract_CdedSupply.Merge(dst, src)
}
func (m *AssetIssueContract_CdedSupply) XXX_Size() int {
	return xxx_messageInfo_AssetIssueContract_CdedSupply.Size(m)
}
func (m *AssetIssueContract_CdedSupply) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetIssueContract_CdedSupply.DiscardUnknown(m)
}

var xxx_messageInfo_AssetIssueContract_CdedSupply proto.InternalMessageInfo

func (m *AssetIssueContract_CdedSupply) GetCdedAmount() int64 {
	if m != nil {
		return m.CdedAmount
	}
	return 0
...
func (m *AssetIssueContract_CdedSupply) GetCdedDays() int64 {
	if m != nil {
		return m.CdedDays
	}
	return 0
...
type CdBalanceContract struct {
	OwnerAddress         []byte   `protobuf:"bytes,1,opt,name=owner_address,json=ownerAddress,proto3" json:"owner_address,omitempty"`
	CdedBalance        int64    `protobuf:"varint,2,opt,name=cded_balance,json=cdedBalance,proto3" json:"cded_balance,omitempty"`
	CdedDuration       int64    `protobuf:"varint,3,opt,name=cded_duration,json=cdedDuration,proto3" json:"cded_duration,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CdBalanceContract) Reset()         { *m = CdBalanceContract{} }
func (m *CdBalanceContract) String() string { return proto.CompactTextString(m) }
func (*CdBalanceContract) ProtoMessage()    {}
func (*CdBalanceContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{11}
}
func (m *CdBalanceContract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CdBalanceContract.Unmarshal(m, b)
}
func (m *CdBalanceContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CdBalanceContract.Marshal(b, m, deterministic)
}
func (dst *CdBalanceContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CdBalanceContract.Merge(dst, src)
}
func (m *CdBalanceContract) XXX_Size() int {
	return xxx_messageInfo_CdBalanceContract.Size(m)
}
func (m *CdBalanceContract) XXX_DiscardUnknown() {
	xxx_messageInfo_CdBalanceContract.DiscardUnknown(m)
}

var xxx_messageInfo_CdBalanceContract proto.InternalMessageInfo

func (m *CdBalanceContract) GetOwnerAddress() []byte {
	if m != nil {
		return m.OwnerAddress
	}
	return nil
...
func (m *CdBalanceContract) GetCdedBalance() int64 {
	if m != nil {
		return m.CdedBalance
	}
	return 0
}

func (m *CdBalanceContract) GetCdedDuration() int64 {
	if m != nil {
		return m.CdedDuration
	}
	return 0
}

type UncdBalanceContract struct {
	OwnerAddress         []byte   `protobuf:"bytes,1,opt,name=owner_address,json=ownerAddress,proto3" json:"owner_address,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *UncdBalanceContract) Reset()         { *m = UncdBalanceContract{} }
func (m *UncdBalanceContract) String() string { return proto.CompactTextString(m) }
func (*UncdBalanceContract) ProtoMessage()    {}
func (*UncdBalanceContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{12}
}
func (m *UncdBalanceContract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UncdBalanceContract.Unmarshal(m, b)
}
func (m *UncdBalanceContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UncdBalanceContract.Marshal(b, m, deterministic)
}
func (dst *UncdBalanceContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UncdBalanceContract.Merge(dst, src)
}
func (m *UncdBalanceContract) XXX_Size() int {
	return xxx_messageInfo_UncdBalanceContract.Size(m)
}
func (m *UncdBalanceContract) XXX_DiscardUnknown() {
	xxx_messageInfo_UncdBalanceContract.DiscardUnknown(m)
}

var xxx_messageInfo_UncdBalanceContract proto.InternalMessageInfo

func (m *UncdBalanceContract) GetOwnerAddress() []byte {
	if m != nil {
		return m.OwnerAddress
	}
	return nil
...
func (m *UncdAssetContract) Reset()         { *m = UncdAssetContract{} }
func (m *UncdAssetContract) String() string { return proto.CompactTextString(m) }
func (*UncdAssetContract) ProtoMessage()    {}
func (*UncdAssetContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_Contract_8bf0fc65532db470, []int{13}
}
func (m *UncdAssetContract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UncdAssetContract.Unmarshal(m, b)
}
func (m *UncdAssetContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UncdAssetContract.Marshal(b, m, deterministic)
}
func (dst *UncdAssetContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UncdAssetContract.Merge(dst, src)
}
func (m *UncdAssetContract) XXX_Size() int {
	return xxx_messageInfo_UncdAssetContract.Size(m)
}
func (m *UncdAssetContract) XXX_DiscardUnknown() {
	xxx_messageInfo_UncdAssetContract.DiscardUnknown(m)
}

var xxx_messageInfo_UncdAssetContract proto.InternalMessageInfo

func (m *UncdAssetContract) GetOwnerAddress() []byte {
	if m != nil {
		return m.OwnerAddress
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*VoteexecutiveContract)(nil), "protocol.VoteexecutiveContract")
	proto.RegisterType((*VoteexecutiveContract_Vote)(nil), "protocol.VoteexecutiveContract.Vote")
	proto.RegisterType((*executiveCreateContract)(nil), "protocol.executiveCreateContract")
	proto.RegisterType((*executiveUpdateContract)(nil), "protocol.executiveUpdateContract")
	proto.RegisterType((*AssetIssueContract)(nil), "protocol.AssetIssueContract")
	proto.RegisterType((*AssetIssueContract_CdedSupply)(nil), "protocol.AssetIssueContract.CdedSupply")
	...
	proto.RegisterType((*CdBalanceContract)(nil), "protocol.CdBalanceContract")
	proto.RegisterType((*UncdBalanceContract)(nil), "protocol.UncdBalanceContract")
	proto.RegisterType((*UncdAssetContract)(nil), "protocol.UncdAssetContract")
