...
package api // import "github.com/stabilaprotocol/grpc-gateway/api"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import core "github.com/stabilaprotocol/grpc-gateway/core"
...
type executiveList struct {
	executives            []*core.executive `protobuf:"bytes,1,rep,name=executives,proto3" json:"executives,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *executiveList) Reset()         { *m = executiveList{} }
func (m *executiveList) String() string { return proto.CompactTextString(m) }
func (*executiveList) ProtoMessage()    {}
func (*executiveList) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_2b4f1aef810550ab, []int{2}
}
func (m *executiveList) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_executiveList.Unmarshal(m, b)
}
func (m *executiveList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_executiveList.Marshal(b, m, deterministic)
}
func (dst *executiveList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_executiveList.Merge(dst, src)
}
func (m *executiveList) XXX_Size() int {
	return xxx_messageInfo_executiveList.Size(m)
}
func (m *executiveList) XXX_DiscardUnknown() {
	xxx_messageInfo_executiveList.DiscardUnknown(m)
}

var xxx_messageInfo_executiveList proto.InternalMessageInfo

func (m *executiveList) Getexecutives() []*core.executive {
	if m != nil {
		return m.executives
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*executiveList)(nil), "protocol.executiveList")
...
type WalletClient interface {
	...
	VoteexecutiveAccount(ctx context.Context, in *core.VoteexecutiveContract, opts ...grpc.CallOption) (*core.Transaction, error)
	CreateAssetIssue(ctx context.Context, in *core.AssetIssueContract, opts ...grpc.CallOption) (*core.Transaction, error)
	Updateexecutive(ctx context.Context, in *core.executiveUpdateContract, opts ...grpc.CallOption) (*core.Transaction, error)
	CreateAccount(ctx context.Context, in *core.AccountCreateContract, opts ...grpc.CallOption) (*core.Transaction, error)
	Createexecutive(ctx context.Context, in *core.executiveCreateContract, opts ...grpc.CallOption) (*core.Transaction, error)
	...
	CdBalance(ctx context.Context, in *core.CdBalanceContract, opts ...grpc.CallOption) (*core.Transaction, error)
	UncdBalance(ctx context.Context, in *core.UncdBalanceContract, opts ...grpc.CallOption) (*core.Transaction, error)
	UncdAsset(ctx context.Context, in *core.UncdAssetContract, opts ...grpc.CallOption) (*core.Transaction, error)
	...
	Listexecutives(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*executiveList, error)
...
func (c *walletClient) VoteexecutiveAccount(ctx context.Context, in *core.VoteexecutiveContract, opts ...grpc.CallOption) (*core.Transaction, error) {
	out := new(core.Transaction)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/VoteexecutiveAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletClient) Updateexecutive(ctx context.Context, in *core.executiveUpdateContract, opts ...grpc.CallOption) (*core.Transaction, error) {
	out := new(core.Transaction)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/Updateexecutive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletClient) Createexecutive(ctx context.Context, in *core.executiveCreateContract, opts ...grpc.CallOption) (*core.Transaction, error) {
	out := new(core.Transaction)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/Createexecutive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletClient) CdBalance(ctx context.Context, in *core.CdBalanceContract, opts ...grpc.CallOption) (*core.Transaction, error) {
	out := new(core.Transaction)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/CdBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletClient) UncdBalance(ctx context.Context, in *core.UncdBalanceContract, opts ...grpc.CallOption) (*core.Transaction, error) {
	out := new(core.Transaction)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/UncdBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletClient) UncdAsset(ctx context.Context, in *core.UncdAssetContract, opts ...grpc.CallOption) (*core.Transaction, error) {
	out := new(core.Transaction)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/UncdAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletClient) Listexecutives(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*executiveList, error) {
	out := new(executiveList)
	err := c.cc.Invoke(ctx, "/protocol.Wallet/Listexecutives", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletServer interface {
	...
	VoteexecutiveAccount(context.Context, *core.VoteexecutiveContract) (*core.Transaction, error)
	CreateAssetIssue(context.Context, *core.AssetIssueContract) (*core.Transaction, error)
	Updateexecutive(context.Context, *core.executiveUpdateContract) (*core.Transaction, error)
	CreateAccount(context.Context, *core.AccountCreateContract) (*core.Transaction, error)
	Createexecutive(context.Context, *core.executiveCreateContract) (*core.Transaction, error)
	...
	CdBalance(context.Context, *core.CdBalanceContract) (*core.Transaction, error)
	UncdBalance(context.Context, *core.UncdBalanceContract) (*core.Transaction, error)
	UncdAsset(context.Context, *core.UncdAssetContract) (*core.Transaction, error)
	...
	Listexecutives(context.Context, *EmptyMessage) (*executiveList, error)
...
func _Wallet_VoteexecutiveAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.VoteexecutiveContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).VoteexecutiveAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/VoteexecutiveAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).VoteexecutiveAccount(ctx, req.(*core.VoteexecutiveContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_Updateexecutive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.executiveUpdateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).Updateexecutive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/Updateexecutive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).Updateexecutive(ctx, req.(*core.executiveUpdateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_Createexecutive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.executiveCreateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).Createexecutive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/Createexecutive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).Createexecutive(ctx, req.(*core.executiveCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CdBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.CdBalanceContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).CdBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/CdBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CdBalance(ctx, req.(*core.CdBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}

func _Wallet_UncdBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.UncdBalanceContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).UncdBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/UncdBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UncdBalance(ctx, req.(*core.UncdBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}

func _Wallet_UncdAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.UncdAssetContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).UncdAsset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/UncdAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UncdAsset(ctx, req.(*core.UncdAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_Listexecutives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletServer).Listexecutives(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.Wallet/Listexecutives",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).Listexecutives(ctx, req.(*EmptyMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Wallet_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VoteexecutiveAccount",
			Handler:    _Wallet_VoteexecutiveAccount_Handler,
		},
		{
		...
		{
			MethodName: "Updateexecutive",
			Handler:    _Wallet_Updateexecutive_Handler,
		},
		{
		...
		{
			MethodName: "Createexecutive",
			Handler:    _Wallet_Createexecutive_Handler,
		},
		{
		...
		{
			MethodName: "CdBalance",
			Handler:    _Wallet_CdBalance_Handler,
		},
		{
			MethodName: "UncdBalance",
			Handler:    _Wallet_UncdBalance_Handler,
		},
		{
			MethodName: "UncdAsset",
			Handler:    _Wallet_UncdAsset_Handler,
		},
		{
		...
		{
			MethodName: "Listexecutives",
			Handler:    _Wallet_Listexecutives_Handler,
		},
		{
...
func (c *walletSolidityClient) Listexecutives(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*executiveList, error) {
	out := new(executiveList)
	err := c.cc.Invoke(ctx, "/protocol.WalletSolidity/Listexecutives", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WalletSolidity_Listexecutives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WalletSolidityServer).Listexecutives(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.WalletSolidity/Listexecutives",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).Listexecutives(ctx, req.(*EmptyMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WalletSolidity_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Listexecutives",
			Handler:    _WalletSolidity_Listexecutives_Handler,
		},
		{
			MethodName: "GetAssetIssueList",
